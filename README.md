...
Реализация библиотеки string.h на языке программирования Си с собственной реализацией функций sprintf и sscanf.

## Introduction

В данном проекте риализована библиотека string.h на языке программирования Си с собственной реализацией функций sprintf и sscanf. Библиотека string.h является основной библиотекой языка Си по обработке строк.
...
- Сборка библиотеки и тестов осуществляется с помощью Makefile, с целями all, clean, test, s21_string.a, gcov_report
